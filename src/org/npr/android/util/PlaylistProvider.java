...
public class PlaylistProvider extends ContentProvider {
  public static final Uri CONTENT_URI =
      Uri.parse("content://org.npr.android.util.Playlist");
  ...
  /**
   * For testing purposes, allows to override the existing helper
   * so we don't touch the actual filesystem.
   * @param helper
   */
  ...
  public static class Items implements BaseColumns {
    ...
    public static final String[] ALL_COLUMNS =
        {BaseColumns._ID, NAME, URL, PLAY_ORDER, IS_READ};
